...
import 'package:fluttest/models/image_message.dart';
import 'package:fluttest/models/message.dart';
import 'package:fluttest/models/text_message.dart';
import 'package:fluttest/pages/list_page.dart';
import 'package:fluttest/services/images_service.dart';
import 'package:fluttest/services/messages_service.dart';
import 'package:fluttest/styles.dart';
import 'package:fluttest/widgets/image_message_widget.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:fluttest/widgets/text_message_widget.dart';
      ...
      children: [
        Expanded(
          child: FirestoreListView<Message>(
            reverse: true,
            query: MessagesServices.getMessages(conversation.id).orderBy(
              'createdAt',
              descending: true,
            ),
